...
class TruffleClient extends plugin_1.PluginClient {
    ...
    listenOnTruffleCompilation() {
        try {
            ...
            this.watcher.on('change', (f) => tslib_1.__awaiter(this, void 0, void 0, function* () { return this.processArtifact(); }));
            this.watcher.on('add', (f) => tslib_1.__awaiter(this, void 0, void 0, function* () { return this.processArtifact(); }));
